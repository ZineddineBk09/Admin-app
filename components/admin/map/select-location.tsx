    ...
    <>
      ...
      <div className='w-fit flex flex-col items-start gap-y-5 absolute bottom-0 left-4 z-10 pb-4'>
          ...
          {['latitude', 'longitude'].map((item: string, index: number) => (
            ...
            >
              ...
              <input
                ...
                type='text'
                placeholder='0'
                className='h-8 max-w-[130px] bg-gray-200 rounded px-4'
                //@ts-ignore
        ...
        <div className='flex items-center gap-x-5'>
          <button
            className={`h-10 px-2 bg-primary rounded font-medium shadow-lg text-xs md:text-sm md:px-5 
          ${
            formik.isValid
          ...
          <button className='h-10 px-4 bg-red-500 rounded font-medium text-xs md:text-sm shadow-lg hover:bg-opacity-90 transition-all duration-300 md:px-8'>
            Cancel
          </button>
        </div>
      </div>
