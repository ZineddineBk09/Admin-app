        ...
        <>
          ...
          <>
            <div className='flex items-center gap-x-6'>
              <LabelField>Discount</LabelField>
...
const Btn = ({
  ...
  return (
    <button
      className={`min-w-[128px] relative font-medium text-sm shadow-md shadow-black/30 rounded-md text-center py-2 bg-${bg} px-2 transition-all duration-300 hover:bg-opacity-90 cursor-pointer lg:px-10`}
    >
      {children}
    </button>
  )
